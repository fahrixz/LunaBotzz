...
## ```Heroku Buildpack```
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/fahrixz/LunaBotzz)
...
$ git clone https://github.com/fahrixz/LunaBotzz
$ cd LunaBotzz
$ npm i
```
...
```bash
git https://github.com/fahrixz/LunaBotzz
cd LunaBotzz
npm install
npm update
```
